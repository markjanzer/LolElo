  ...
  describe "#call" do
    context "when the panda_score_league does not exist" do
      it "raises an error" do
        expect { described_class.new(panda_score_id: 1, time_zone: "UTC").call }.to raise_error(StandardError)
      end
    end

    context "when time_zone is nil" do
      it "raises an error" do
        expect { described_class.new(panda_score_id: 1, time_zone: nil).call }.to raise_error(StandardError)
      end
    end
    ...
    context "when the league does not exist" do
      it "creates a league" do
        ...
        expect { described_class.new(panda_score_id: 1, time_zone: "UTC").call }
